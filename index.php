    ...
    <div class="container mt-4">
        ...
        <form id="uploadForm" action="upload.php" method="post">
            <div class="form-group">
                <label for="video_url">Введите адрес видео на YouTube:</label>
                <input type="text" class="form-control" id="video_url" name="video_url" placeholder="Введите URL видео">
            </div>

            <div class="form-group">
                <label for="video_title">Введите название видео:</label>
                <input type="text" class="form-control" id="video_title" name="video_title" placeholder="Введите название видео">
            </div>

            <div class="d-flex justify-content-between">
                <button class="btn btn-success" type="submit">Загрузить видео</button>
                <button class="btn btn-secondary" type="button" onclick="reloadPage()">Очистить форму</button>
            </div>
        </form>
    </div>
